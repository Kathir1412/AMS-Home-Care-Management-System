        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeeklyOffDay = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_Employees_AssignedEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SupervisorNotes = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DutyAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DutyAssignments_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DutyAssignments_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DutyAssignments_EmployeeId",
                table: "DutyAssignments",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_DutyAssignments_PatientId",
                table: "DutyAssignments",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_AssignedEmployeeId",
                table: "Patients",
